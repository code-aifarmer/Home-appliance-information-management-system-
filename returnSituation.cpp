...
#include "situation.h"
using namespace std;
ReturnSituation::ReturnSituation(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::ReturnSituation)
{
    ui->setupUi(this);
...
void ReturnSituation::on_pushButton_clicked()
{
...
void ReturnSituation::on_pushButton_2_clicked()
{
    QString fp=FILEPATH;
    fp+="sum_info/";
    fp=fp+find_username+"/return_goods_info.txt";
...
void ReturnSituation::on_pushButton_3_clicked()
{
    QString fp=FILEPATH;
    fp+="sum_info/";
    fp=fp+find_username+"/return_goods_info.txt";
